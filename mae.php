...
<?php function check_if_added_to_cart($item_id)
{
    ...
    $user_id = $_SESSION['id'];
    $query_added_to_cart = "SELECT * FROM cart WHERE Event_id='$item_id' AND User_id ='$user_id' AND Status='Added to cart' AND Branch = 'mae' ;";
...
<head>
    <title> Inceptum | MA Events</title>
...
<body class="black-color">
    ...
    <content>
        ...
        <div class="container top-layout">
            <center>
                <b>
                    <p style="font-size: 32px;">MECHANICAL AND AUTOMATION EVENTS</p>
                </b>
            </center>
            <div class="row text-center">
                <?php
                $select_event_query = "SELECT * from mae ORder by Id;";
                $result_event_query = mysqli_query($conn, $select_event_query);

                while ($row = mysqli_fetch_array($result_event_query)) {
                    ?>

                    <div class="col-xs-6 offset-xs-3 col-sm-4 offset-sm-1 ">
                        <div class="contain">
                            <?php echo '<img src="assets/img/mae/mae' . $row['Id'] . '.jpeg" alt="MAE Events" class="image" style="width:100%; height: 200px;">';   ?>
                            <div class="middle">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <h5 style="color:#000; text-align:left;"><strong>Rules:</strong><br>
                            <?php
                                echo nl2br(htmlspecialchars($row['Rules']));   ?>
                        ...
                        <h5 style="color:#000; text-align:left;"><strong>Registration Charges:</strong><br>
                          ...
                          <div class="card" style="width:200px;">
                                <div class="card-body" style="width:200px; color:#000;">
                                    <h5 class="card-title"><?php echo $row['Cname1']; ?></h5>                    
                                   <?php echo '<a href="tel:+91-'.$row['Contact1'].'" class="btn btn-success btn-sm"><img src="assets/img/call.png" height="30px" width="30px">&nbsp;+91-'.$row['Contact1'].'</a>';?>
                                </div>
                            </div>
                              <div class="card" style="width:200px;">
                                <div class="card-body" style="width:200px; color:#000;">
                                    <h5 class="card-title"><?php echo $row['Cname2']; ?></h5>                    
                                   <?php echo '<a href="tel:+91-'.$row['Contact2'].'" class="btn btn-success btn-sm"><img src="assets/img/call.png" height="30px" width="30px">&nbsp;+91-'.$row['Contact2'].'</a>';?>
                                </div>
                            </div>
                    </div>
