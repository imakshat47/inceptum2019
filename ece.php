...
<?php function check_if_added_to_cart($item_id)
{
    ...
    $user_id = $_SESSION['id'];
    $query_added_to_cart = "SELECT * FROM cart WHERE Event_id='$item_id' AND User_id ='$user_id' AND Status='Added to cart' AND Branch = 'ece' ;";
...
<head>
    <title> Inceptum | EC Events</title>
...
<body class="black-color">
    ...
    <content>
        ...
        <div class="container top-layout">
            <center>
                <b>
                    <p style="font-size: 32px;">ELECTRICAL AND ELECTRONICS EVENTS</p>
                </b>
            </center>
            <div class="row text-center">
                <?php
                $select_event_query = "SELECT * from ece Order by Id;";
                ...
                while ($row = mysqli_fetch_array($result_event_query)) {
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                        <div class="contain">
                            <?php echo '<img src="assets/img/ece/ece' . $row['Id'] . '.jpeg" alt="EC Events" class="image" style="width:100%; height: 200px; ">'; ?>
                            <div class="middle">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <h5 style="color:#000; text-align:left;"><strong>Type:</strong><br>
                            <?php
                                echo nl2br($row['Type']);   ?>
